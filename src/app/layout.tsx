...
export default function RootLayout({
  ...
  return (
    ...
    >
      <title>Particle - the ultimate digital content manager</title>
      <meta
        name="description"
        content="Particle - the ultimate digital content manager. With Particle, you can easily organize and access all your digital content in one place. Our AI-powered search features allow you to quickly find what you need, while our natural language processing technology helps you better manage and categorize your content."
      />
