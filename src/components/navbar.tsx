...
const user = {
  ...
  email: "particle@example.com",
  imageUrl:
    "https://images.unsplash.com/photo-1661819983415-d5f4f6597f91?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=256&h=256&q=80",
};
